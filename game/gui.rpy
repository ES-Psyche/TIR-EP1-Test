...
define config.name = _("Tears In Rain")

## The version of the game.
define config.version = "0.1"

## The name of the developer.
define gui.developer_name = "Ethereal Studios"

## Name of your build. This must be ASCII-only, and must not contain spaces, colons,
## or semicolons.
define build.name = "Tears_In_Rain"
...
define config.save_directory = "ES_TIR"

# Your website. This will be clickable via the "web" icon on the main menu
# in the lower corner.
define gui.developer_site = "https://patreon.com/EtherealStudios"
define gui.developer_site2 = "https://discord.gg/bQqn3n2zYj"
...
define gui.mm_background = "images/Main_Menu/mex.png"
define gui.sm_background = "images/Main_Menu/dcf.png"
define gui.slm_background = "images/Main_Menu/mm1.png"
...
define config.main_menu_music = "audio/mp_pain.mp3"
#define config.main_menu_music = "audio/TearsbyH.mp3"
...
## Name text: font
define gui.advname_font_face = "fonts/mordred.bold.ttf"

## Name text: size
define gui.advname_font_size = 35

## Name text: color
define gui.advname_font_color ='#F8F9FA'

# Name text: kerning. This is the amount of pixels between each letter.
define gui.advname_font_kerning = 4
...
## Dialogue text: font
define gui.adv_font_face = "fonts/Elegant Lux Pro Mager.ttf"

## Menu text: font
define gui.adv_font_mm = "fonts/mordred.bold.ttf"
define gui.adv_font_color ='#D3F8FF'
...
#init python:
    #config.font_replacement_map["fonts/mordred.regular.ttf", True, False] = ("fonts/mordred.bold.ttf", False, False)
...
## Dialogue text: size
define gui.adv_font_size = 35

## Dialogue text: color
define gui.adv_font_color = '#FBFFFF'
