...
init python:
    ...
    song_list = {"audio/mmbgm.mp3":['Main Menu Music', ''],
                "audio/cold_suspense.mp3":['Cold Suspense', ''],
                "audio/vw_wr.mp3":['Wood Rain', ''],
                "audio/ds_pa.mp3":['Direct Space', 'CO.AG'],
                "audio/dh2_mmp.mp3":['Wood Rain', ''],
                }
