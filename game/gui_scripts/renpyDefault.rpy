...
style gui_overlay_title:
    ...
    color Color(color=gui.advname_font_color,alpha=0.3)
    kerning gui.advname_font_kerning * 1.3

    text_align 0.5
    xalign 0.5
    yoffset -15

style gui_exit_tooltip:
...
define gui.text_font = "fonts/mordred.regular.ttf"

## The font used for character names.
define gui.name_text_font = "fonts/mordred.bold.ttf"

## The font used for out-of-game text.
define gui.interface_text_font = "fonts/Elegant Lux Pro Mager.ttf"
...
#            input id "input"
    ...
    window:
        ...
        window:
            text prompt style "input" xpos 300 ypos 50


        input id "what" xpos 300 ypos 120 color "#f3f3f3"
